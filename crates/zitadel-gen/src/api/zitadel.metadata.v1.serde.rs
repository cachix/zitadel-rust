...
impl serde::Serialize for Metadata {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.metadata.v1.Metadata", len)?;
...
impl<'de> serde::Deserialize<'de> for Metadata {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.metadata.v1.Metadata")
            }
        ...
        deserializer.deserialize_struct("zitadel.metadata.v1.Metadata", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MetadataKeyQuery {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.metadata.v1.MetadataKeyQuery", len)?;
        if !self.key.is_empty() {
            struct_ser.serialize_field("key", &self.key)?;
        }
        if self.method != 0 {
...
impl<'de> serde::Deserialize<'de> for MetadataKeyQuery {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.metadata.v1.MetadataKeyQuery")
            }
        ...
        deserializer.deserialize_struct("zitadel.metadata.v1.MetadataKeyQuery", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MetadataQuery {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.metadata.v1.MetadataQuery", len)?;
...
impl<'de> serde::Deserialize<'de> for MetadataQuery {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.metadata.v1.MetadataQuery")
            }
...
;
        ...
        deserializer.deserialize_struct("zitadel.metadata.v1.MetadataQuery", FIELDS, GeneratedVisitor)
    }
}
