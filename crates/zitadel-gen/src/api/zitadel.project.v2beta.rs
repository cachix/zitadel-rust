...
impl GrantedProjectState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            GrantedProjectState::Unspecified => "GRANTED_PROJECT_STATE_UNSPECIFIED",
            GrantedProjectState::Active => "GRANTED_PROJECT_STATE_ACTIVE",
            GrantedProjectState::Inactive => "GRANTED_PROJECT_STATE_INACTIVE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ProjectFieldName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ProjectFieldName::Unspecified => "PROJECT_FIELD_NAME_UNSPECIFIED",
            ProjectFieldName::Id => "PROJECT_FIELD_NAME_ID",
            ProjectFieldName::CreationDate => "PROJECT_FIELD_NAME_CREATION_DATE",
            ProjectFieldName::ChangeDate => "PROJECT_FIELD_NAME_CHANGE_DATE",
            ProjectFieldName::Name => "PROJECT_FIELD_NAME_NAME",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ProjectGrantFieldName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ProjectGrantFieldName::Unspecified => "PROJECT_GRANT_FIELD_NAME_UNSPECIFIED",
            ProjectGrantFieldName::ProjectId => "PROJECT_GRANT_FIELD_NAME_PROJECT_ID",
            ProjectGrantFieldName::CreationDate => "PROJECT_GRANT_FIELD_NAME_CREATION_DATE",
            ProjectGrantFieldName::ChangeDate => "PROJECT_GRANT_FIELD_NAME_CHANGE_DATE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ProjectRoleFieldName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ProjectRoleFieldName::Unspecified => "PROJECT_ROLE_FIELD_NAME_UNSPECIFIED",
            ProjectRoleFieldName::Key => "PROJECT_ROLE_FIELD_NAME_KEY",
            ProjectRoleFieldName::CreationDate => "PROJECT_ROLE_FIELD_NAME_CREATION_DATE",
            ProjectRoleFieldName::ChangeDate => "PROJECT_ROLE_FIELD_NAME_CHANGE_DATE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
