...
impl TimestampFilterMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            TimestampFilterMethod::Greater => "TIMESTAMP_FILTER_METHOD_GREATER",
            TimestampFilterMethod::GreaterOrEquals => "TIMESTAMP_FILTER_METHOD_GREATER_OR_EQUALS",
            TimestampFilterMethod::Less => "TIMESTAMP_FILTER_METHOD_LESS",
            TimestampFilterMethod::LessOrEquals => "TIMESTAMP_FILTER_METHOD_LESS_OR_EQUALS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
