...
impl TextFilterMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            TextFilterMethod::ContainsIgnoreCase => "TEXT_FILTER_METHOD_CONTAINS_IGNORE_CASE",
            TextFilterMethod::EndsWith => "TEXT_FILTER_METHOD_ENDS_WITH",
            TextFilterMethod::EndsWithIgnoreCase => "TEXT_FILTER_METHOD_ENDS_WITH_IGNORE_CASE",
        }
    }
...
impl ListFilterMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ListFilterMethod::In => "LIST_FILTER_METHOD_IN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TimestampFilterMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TimestampFilterMethod::Equals => "TIMESTAMP_FILTER_METHOD_EQUALS",
            TimestampFilterMethod::After => "TIMESTAMP_FILTER_METHOD_AFTER",
            TimestampFilterMethod::AfterOrEquals => "TIMESTAMP_FILTER_METHOD_AFTER_OR_EQUALS",
            TimestampFilterMethod::Before => "TIMESTAMP_FILTER_METHOD_BEFORE",
            TimestampFilterMethod::BeforeOrEquals => "TIMESTAMP_FILTER_METHOD_BEFORE_OR_EQUALS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
include!("zitadel.filter.v2.serde.rs");
