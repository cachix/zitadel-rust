...
impl serde::Serialize for IdFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.filter.v2beta.IDFilter", len)?;
        if !self.id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for IdFilter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.filter.v2beta.IDFilter")
            }
        ...
        deserializer.deserialize_struct("zitadel.filter.v2beta.IDFilter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for InIDsFilter {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.filter.v2beta.InIDsFilter", len)?;
        if !self.ids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for InIDsFilter {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = InIDsFilter;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.filter.v2beta.InIDsFilter")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<InIDsFilter, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ids__ = None;
        ...
        deserializer.deserialize_struct("zitadel.filter.v2beta.InIDsFilter", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for PaginationRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.filter.v2beta.PaginationRequest", len)?;
        if self.offset != 0 {
...
impl<'de> serde::Deserialize<'de> for PaginationRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.filter.v2beta.PaginationRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.filter.v2beta.PaginationRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PaginationResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.filter.v2beta.PaginationResponse", len)?;
        if self.total_result != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for PaginationResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.filter.v2beta.PaginationResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.filter.v2beta.PaginationResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TimestampFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.filter.v2beta.TimestampFilter", len)?;
...
impl<'de> serde::Deserialize<'de> for TimestampFilter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.filter.v2beta.TimestampFilter")
            }
        ...
        deserializer.deserialize_struct("zitadel.filter.v2beta.TimestampFilter", FIELDS, GeneratedVisitor)
    }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "TIMESTAMP_FILTER_METHOD_GREATER" => Ok(TimestampFilterMethod::Greater),
                    "TIMESTAMP_FILTER_METHOD_GREATER_OR_EQUALS" => Ok(TimestampFilterMethod::GreaterOrEquals),
                    "TIMESTAMP_FILTER_METHOD_LESS" => Ok(TimestampFilterMethod::Less),
                    "TIMESTAMP_FILTER_METHOD_LESS_OR_EQUALS" => Ok(TimestampFilterMethod::LessOrEquals),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
