...
impl AuthorizationFieldName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            AuthorizationFieldName::Unspecified => "AUTHORIZATION_FIELD_NAME_UNSPECIFIED",
            AuthorizationFieldName::CreatedDate => "AUTHORIZATION_FIELD_NAME_CREATED_DATE",
            AuthorizationFieldName::ChangedDate => "AUTHORIZATION_FIELD_NAME_CHANGED_DATE",
            AuthorizationFieldName::Id => "AUTHORIZATION_FIELD_NAME_ID",
            AuthorizationFieldName::UserId => "AUTHORIZATION_FIELD_NAME_USER_ID",
            AuthorizationFieldName::ProjectId => "AUTHORIZATION_FIELD_NAME_PROJECT_ID",
            AuthorizationFieldName::OrganizationId => "AUTHORIZATION_FIELD_NAME_ORGANIZATION_ID",
            AuthorizationFieldName::UserOrganizationId => "AUTHORIZATION_FIELD_NAME_USER_ORGANIZATION_ID",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
