...
impl serde::Serialize for GetHostedLoginTranslationRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.ignore_inheritance {
            len += 1;
        }
        if self.level.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetHostedLoginTranslationRequest", len)?;
        if !self.locale.is_empty() {
            struct_ser.serialize_field("locale", &self.locale)?;
        }
        if self.ignore_inheritance {
            struct_ser.serialize_field("ignoreInheritance", &self.ignore_inheritance)?;
        }
        if let Some(v) = self.level.as_ref() {
            match v {
                get_hosted_login_translation_request::Level::System(v) => {
                    struct_ser.serialize_field("system", v)?;
                }
                get_hosted_login_translation_request::Level::Instance(v) => {
                    struct_ser.serialize_field("instance", v)?;
                }
                get_hosted_login_translation_request::Level::OrganizationId(v) => {
...
impl<'de> serde::Deserialize<'de> for GetHostedLoginTranslationRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "ignoreInheritance" | "ignore_inheritance" => Ok(GeneratedField::IgnoreInheritance),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetHostedLoginTranslationRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetHostedLoginTranslationRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetHostedLoginTranslationRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut locale__ = None;
                let mut ignore_inheritance__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::IgnoreInheritance => {
                            if ignore_inheritance__.is_some() {
                                return Err(serde::de::Error::duplicate_field("ignoreInheritance"));
                            }
                            ignore_inheritance__ = Some(map_.next_value()?);
                        }
                        GeneratedField::System => {
                            if level__.is_some() {
                                return Err(serde::de::Error::duplicate_field("system"));
                            }
                            level__ = map_.next_value::<::std::option::Option<_>>()?.map(get_hosted_login_translation_request::Level::System);
                        }
                        GeneratedField::Instance => {
                            if level__.is_some() {
                                return Err(serde::de::Error::duplicate_field("instance"));
                            }
                            level__ = map_.next_value::<::std::option::Option<_>>()?.map(get_hosted_login_translation_request::Level::Instance);
                        }
                        GeneratedField::OrganizationId => {
                            if level__.is_some() {
                                return Err(serde::de::Error::duplicate_field("organizationId"));
                            }
                            level__ = map_.next_value::<::std::option::Option<_>>()?.map(get_hosted_login_translation_request::Level::OrganizationId);
                        }
                    }
                }
                Ok(GetHostedLoginTranslationRequest {
                    locale: locale__.unwrap_or_default(),
                    ignore_inheritance: ignore_inheritance__.unwrap_or_default(),
                    level: level__,
                })
            }
        }
        deserializer.deserialize_struct("zitadel.settings.v2.GetHostedLoginTranslationRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetHostedLoginTranslationResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetHostedLoginTranslationResponse", len)?;
        if !self.etag.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetHostedLoginTranslationResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetHostedLoginTranslationResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetHostedLoginTranslationResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetHostedLoginTranslationResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut etag__ = None;
                ...
                Ok(GetHostedLoginTranslationResponse {
                    etag: etag__.unwrap_or_default(),
                    translations: translations__,
                })
            }
        }
        deserializer.deserialize_struct("zitadel.settings.v2.GetHostedLoginTranslationResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SetHostedLoginTranslationRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.SetHostedLoginTranslationRequest", len)?;
        if !self.locale.is_empty() {
            struct_ser.serialize_field("locale", &self.locale)?;
        }
        if let Some(v) = self.translations.as_ref() {
        ...
        if let Some(v) = self.level.as_ref() {
            match v {
                set_hosted_login_translation_request::Level::Instance(v) => {
                    struct_ser.serialize_field("instance", v)?;
                }
                set_hosted_login_translation_request::Level::OrganizationId(v) => {
                    struct_ser.serialize_field("organizationId", v)?;
                }
            }
        }
...
impl<'de> serde::Deserialize<'de> for SetHostedLoginTranslationRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetHostedLoginTranslationRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.SetHostedLoginTranslationRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetHostedLoginTranslationRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut locale__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Instance => {
                            ...
                            level__ = map_.next_value::<::std::option::Option<_>>()?.map(set_hosted_login_translation_request::Level::Instance);
                        }
                        GeneratedField::OrganizationId => {
                            if level__.is_some() {
                                return Err(serde::de::Error::duplicate_field("organizationId"));
                            }
                            level__ = map_.next_value::<::std::option::Option<_>>()?.map(set_hosted_login_translation_request::Level::OrganizationId);
                        }
                    }
                }
                Ok(SetHostedLoginTranslationRequest {
                    locale: locale__.unwrap_or_default(),
                    translations: translations__,
                    level: level__,
                })
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.SetHostedLoginTranslationRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetHostedLoginTranslationResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.SetHostedLoginTranslationResponse", len)?;
        if !self.etag.is_empty() {
            struct_ser.serialize_field("etag", &self.etag)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetHostedLoginTranslationResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetHostedLoginTranslationResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.SetHostedLoginTranslationResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetHostedLoginTranslationResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut etag__ = None;
                ...
                Ok(SetHostedLoginTranslationResponse {
                    etag: etag__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("zitadel.settings.v2.SetHostedLoginTranslationResponse", FIELDS, GeneratedVisitor)
    }
}
