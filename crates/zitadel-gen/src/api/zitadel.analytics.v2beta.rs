...
impl CountParentType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            CountParentType::Unspecified => "COUNT_PARENT_TYPE_UNSPECIFIED",
            CountParentType::Instance => "COUNT_PARENT_TYPE_INSTANCE",
            CountParentType::Organization => "COUNT_PARENT_TYPE_ORGANIZATION",
        }
    }
