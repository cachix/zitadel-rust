...
impl AdministratorFieldName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            AdministratorFieldName::Unspecified => "ADMINISTRATOR_FIELD_NAME_UNSPECIFIED",
            AdministratorFieldName::UserId => "ADMINISTRATOR_FIELD_NAME_USER_ID",
            AdministratorFieldName::CreationDate => "ADMINISTRATOR_FIELD_NAME_CREATION_DATE",
            AdministratorFieldName::ChangeDate => "ADMINISTRATOR_FIELD_NAME_CHANGE_DATE",
        }
    }
