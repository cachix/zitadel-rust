...
impl serde::Serialize for ExpirationDateQuery {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.session.v2.ExpirationDateQuery", len)?;
...
impl<'de> serde::Deserialize<'de> for ExpirationDateQuery {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExpirationDateQuery;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.session.v2.ExpirationDateQuery")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExpirationDateQuery, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ExpirationDateQuery {
                    expiration_date: expiration_date__,
                    method: method__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("zitadel.session.v2.ExpirationDateQuery", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.query.as_ref() {
            match v {
                ...
                search_query::Query::ExpirationDateQuery(v) => {
                    struct_ser.serialize_field("expirationDateQuery", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "expirationDateQuery" | "expiration_date_query" => Ok(GeneratedField::ExpirationDateQuery),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::ExpirationDateQuery => {
                            if query__.is_some() {
                                return Err(serde::de::Error::duplicate_field("expirationDateQuery"));
                            }
                            query__ = map_.next_value::<::std::option::Option<_>>()?.map(search_query::Query::ExpirationDateQuery)
;
                        }
                    }
                }
