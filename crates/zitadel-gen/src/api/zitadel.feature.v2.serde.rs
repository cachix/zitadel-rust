...
impl serde::Serialize for GetInstanceFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if self.console_use_v2_user_api.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.console_use_v2_user_api.as_ref() {
            struct_ser.serialize_field("consoleUseV2UserApi", v)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "consoleUseV2UserApi" | "console_use_v2_user_api" => Ok(GeneratedField::ConsoleUseV2UserApi),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut console_use_v2_user_api__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ConsoleUseV2UserApi => {
                            if console_use_v2_user_api__.is_some() {
                                return Err(serde::de::Error::duplicate_field("consoleUseV2UserApi"));
                            }
                            console_use_v2_user_api__ = map_.next_value()?;
                        }
                    }
                }
                Ok(GetInstanceFeaturesResponse {
                    ...
                    console_use_v2_user_api: console_use_v2_user_api__,
                })
            }
        }
